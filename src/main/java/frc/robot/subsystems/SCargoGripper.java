...
public class SCargoGripper extends Subsystem {
  ...
  public void push() {
    Motors.cargoGripperMaster.set(pushSpeed.getNumber(RobotMap.CARGO_GRIPPER_SPEED).doubleValue());
  }

  public void pull() {
    Motors.cargoGripperMaster.set(pullSpeed.getNumber(RobotMap.CARGO_GRIPPER_SPEED).doubleValue());
  }
