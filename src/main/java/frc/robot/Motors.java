...
public class Motors {
    ...
    private static void swerveInit() {
        if (RobotMap.SWERVE_DRIVE_SUBSYSTEM_IS_IN_USE) {
            ...
            Robot.swerve.addSwerveModule(frontLeft);
            Robot.swerve.addSwerveModule(frontRight);
            Robot.swerve.addSwerveModule(backLeft);
            Robot.swerve.addSwerveModule(backRight);
